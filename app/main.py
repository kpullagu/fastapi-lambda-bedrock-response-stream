...
async def bedrock_stream(topic: str):
    instruction = f"""
    You are an educator to kids and provide information on questions asked by them. Please keep harmful content away. Please respond to question from the kid about {topic}.
    """
    body = json.dumps({
